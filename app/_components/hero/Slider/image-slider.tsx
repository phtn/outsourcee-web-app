	...
	return (
		<SliderContainer>
			<AnimatePresence
				...
				custom={direction}>
				<motion.img
					className='xl:h-[600px] xl:rounded-[54px] lg:h-[500px] lg:rounded-[42px] md:h-[450px] md:rounded-[38px] md:relative z-30 bg-transparent/50 dark:bg-primary-foreground/100 transition-shadow shadow-xl group-hover:shadow-[0_28px_42px_-15px_rgba(0,0,0,0.5)] group-hover:absolute '
					key={page}
